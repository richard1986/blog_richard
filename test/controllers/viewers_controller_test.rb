...
class ViewersControllerTest < ActionController::TestCase
  ...
  test "should create viewer" do
    assert_difference('Viewer.count') do
      post :create, viewer: { id_session: @viewer.id_session, ip_client: @viewer.ip_client, user_agent: @viewer.user_agent, visists: @viewer.visists }
    end
  ...
  test "should update viewer" do
    patch :update, id: @viewer, viewer: { id_session: @viewer.id_session, ip_client: @viewer.ip_client, user_agent: @viewer.user_agent, visists: @viewer.visists }
    assert_redirected_to viewer_path(assigns(:viewer))
  end
